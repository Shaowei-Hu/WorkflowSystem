...
/*         $('#dataTables').DataTable({
			...
			$.each(roles, function(i, item) {
					...
					$("tbody").append(
							"<tr class='rowClickable'><td class='idCell'>"+ item.id + "</td><td>"
									...
									+"<a href='${pageContext.request.contextPath }/authorization/updateRolePage/"+item.id+"'><i class='fa fa-wrench fa-fw'></i></a></td>"
    ...
    function deleteRole(id){
    	$.ajax({
    	    url: '${pageContext.request.contextPath }/authorization/role/'+id,
    	    type: 'DELETE',
